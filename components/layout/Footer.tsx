      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 pb-12"
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-5 flex-wrap">
              <a
                href="https://www.youtube.com/@lovelifemadly6729"
                target="_blank"
          ...
          {/* Programs */}
          <div>
            <h4 style={{ fontSize: '11px', letterSpacing: '2px', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', marginBottom: '16px', fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}>
              Programs
            </h4>
          ...
          <div>
            ...
            <ul className="list-none p-0 m-0 space-y-2.5">
              {[
                { label: 'About Mudleaf', href: '/about' },
                { label: 'What Guides Us', href: '/guides' },
                { label: 'NDIS Information', href: '/ndis' },
                { label: 'Blog', href: '/blog' },
                { label: 'Feedback & Concerns', href: '/feedback' },
          ...
          <div>
            ...
            <ul className="list-none p-0 m-0 space-y-2.5 mb-6">
              {[
                { label: 'Tamil Contemplative Traditions', href: '/tamil' },
                { label: 'Our Framework', href: '/guides' },
                { label: 'MLAT Research', href: '/mlat' },
              ].map((item) => (
                <li key={item.href}>
                  <Link href={item.href} className="footer-link">{item.label}</Link>
                </li>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.25)' }}>
            © 2026 Mudleaf. ABN [number]. Founded by Monica & Philip Allan.
          </p>
          <div className="flex gap-6">
            {[
              { label: 'Privacy', href: '/privacy' },
              { label: 'Terms', href: '/terms' },
              { label: 'NDIS Provider Statement', href: '/ndis' },
            ].map((item) => (
